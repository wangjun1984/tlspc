...
public class DES {
    ...
    /*public static void main(String[] args) {
        try {
        	System.out.println( StringUtil.toHex( DES.generateKey() ) );
        	byte[] key = "11111111".getBytes();
            byte[] iv  = "22222222".getBytes();
            byte[] data = DES.encrypt("hello test".getBytes(), key);
            System.out.println("EBC mode encrypted:" + StringUtil.toHex( data ) );
            System.out.print("EBC mode:");
            System.out.println(new String(DES.decrypt(data, key)));
            data = DES.CBCEncrypt("hello test".getBytes(), key, iv);
            System.out.println("CBC mode encrypted:" + StringUtil.toHex( data ) );
