...
public class Blowfish {
	 ...
	 * 加密
	 * @param data 源字符串明码
	 * @return 加密后的16进制字符串明码
	 */
	public static String encrypt(String data) {
		return encrypt(data, "Blowfish");
	}
	...
	public static String encrypt(String data, String key) {
		return encStr(data, rnd.nextLong(), new BlowfishCBC(key.getBytes(), 0));
	}

	/**
	 * 解密
	 * @param data 加密后的16进制字符串明码
	 * @return 解密后的字符串明码，如果返回null表示发生错误
	 */
	public static String decrypt(String data) {
		return decrypt(data, "Blowfish");
	}
	...
	public static String decrypt(String data, String key) {
		BlowfishCBC bfish = new BlowfishCBC(key.getBytes(), 0);

		// get the number of estimated bytes in the string (cut off broken
		// blocks)
		int nLen = (data.length() >> 1) & ~7;
		...
		int nNumOfBytes = binHexToBytes(data, cbciv, 0, 0, BlowfishCBC.BLOCKSIZE);
		...
		nNumOfBytes = binHexToBytes(data, buf, BlowfishCBC.BLOCKSIZE * 2, 0, nLen);
	...
	private static class BlowfishECB {
		...
		protected long encryptBlock(long lPlainBlock) {
			...
			// cross and return the reassembled block
	...
	public static void main(String[] args) throws Exception {
		String t = encrypt("www.alimama.com|中文|测试", "dotest");
		System.out.println(t);
		System.out.println(decrypt(t, "dotest"));
	}
